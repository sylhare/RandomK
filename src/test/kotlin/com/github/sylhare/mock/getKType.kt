...
/**
 * From https://gist.github.com/udalov/bb6f398c2e643ee69586356fdd67e9b1 by @udalov
 * Deprecated, now that `typeOf<T>()` is available
 */
...
fun Type.toKTypeProjection(): KTypeProjection = when (this) {
    ...
    is TypeVariable<*> -> TODO("Not implemented")
